...
module.exports = async (req, res) => {
    ...
    try {
        ...
        console.log(`[DIAGNÓSTICO] A obter detalhes da tarefa ${taskId}`);
        ...
        return res.status(400).json({ 
            error: `DIAGNÓSTICO: Por favor, copie e cole a estrutura completa da tarefa que está dentro dos parênteses: (${taskStructure})`
        });
